...
I:"ytp-miniplayer-ui"});this.player=a;this.J=!1;this.H=this.C=this.w=void 0;this.M(a,"minimized",this.pG);this.M(a,"onStateChange",this.tN)},S5=function(a){g.EQ.call(this,a);
...
N:{"aria-label":"Close"},K:[g.aN()]});g.B(this,a);a.o(this.G.element);this.M(a.element,"click",this.xx);a=new g.X({F:"button",X:["ytp-miniplayer-replay-button","ytp-button"],N:{"aria-label":"Close"},K:[g.oN()]});g.B(this,a);a.o(this.G.element);this.M(a.element,"click",this.kL);this.M(this.player,"presentingplayerstatechange",this.qG);this.M(this.player,"appresize",this.Yq);this.M(this.player,"fullscreentoggled",this.Yq);this.Yq();this.J=!0}0!=this.player.getPlayerState()&&g.X.prototype.show.call(this);
...
g.h.kL=function(){this.player.playVideo()};
g.h.cz=function(a){if(a.target==this.A.element||a.target==this.B.element)g.S(this.player.O().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.wF(g.WK(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.ma("onExpandMiniplayer")};
g.h.pG=function(){g.N(this.player.getRootNode(),"ytp-player-minimized",this.player.app.H.o)};
g.h.oG=function(){g.YO(this.C);this.H.w();this.w&&this.w.start()};
g.h.qG=function(a){g.V(a.state,32)&&this.D.hide()};
g.h.Yq=function(){var a=this.C,b=g.XK(this.player).getPlayerSize().width;a.Aa=0;a.C=b;a.G=!1;g.$O(a)};
g.h.tN=function(a){this.player.app.H.o&&(0==a?this.hide():this.show())};
...
g.h.Xq=function(){return new g.hh(0,0,0,0)};
